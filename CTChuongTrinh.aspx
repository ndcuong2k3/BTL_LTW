<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CTChuongTrinh.aspx.cs" Inherits="BTL_LTW_G15.CTChuongTrinh1" %>
...
<head runat="server">
    ...
    <link href="CTChuongTrinh.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
       ...
       <%}
        ...
        <div class="dh" style="margin-left:50px" runat="server">
            ...
            <a href="ChuongTrinh.aspx" style="text-decoration:none;font-size:20px" runat="server">Tin tức </a>
           <%-- <a href="Chitiettintuc.aspx" style="text-decoration:none;font-size:20px" runat="server">Chi tiết tin tức</a>--%>
        </div>

        

        <p id="mst" runat="server"></p>
